...
class ProductController {
  ...
  async insert(req: any, res: Response) {
    if(!req.body.name || !req.body.price || !req.body.description || !req.body.stock || !req.body.weight || !req.body.categoryId || !req.file){
      res.sendStatus(500)
      return
    }
  ...
  async update(req: any, res: Response) {
    if(!req.body._id || !req.body.name || !req.body.price || !req.body.description || !req.body.stock || !req.body.weight || !req.body.categoryId || !(req.file || req.body.imageUrl)){
      res.sendStatus(500)
      return
    }
